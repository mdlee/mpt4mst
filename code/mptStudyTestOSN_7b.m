...
% one memory based strategy plus contaminants in a latent mixture
...
markerSize = 8;
fontSize = 14;
modelNames = {'model', 'guess', 'old', 'new', 'similar'};
modelColors = {pantone.ClassicBlue; pantone.Greenery; pantone.Custard; pantone.Tangerine; pantone.Sharkskin};
binWidth = 0.02;
